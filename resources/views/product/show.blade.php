            ...
            @endif
				...
				<div class="col-lg-6">
					<div class="details_content">
						...
						<!-- Проверяем есть ли в базе новая цена, если да --!>
 						<!-- то старая цена зачеркивается а показывается новая--!>
						...
						<div class="in_stock_container">
							...
							<!--Проверка информации о наличии продукта--!>
							@if($product->in_stock)
							    <span>In Stock</span>
							@else
							    <span class="not_in_stock">Not available</span>
							@endif
						</div>
